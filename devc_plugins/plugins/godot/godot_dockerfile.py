...
class GodotDockerfilePlugin(DockerfilePluginBase):
    ...
    def _apply_overrides_to_handler_content(self, dockerfile_handler: DockerfileHandler, args):
        ...
        if not args.godot_version:
            raise ArgumentError("--godot-version not set.")
        ...
        if args.godot_runtime == "mono":
            ...
            env = {
                ...
                "GODOT_URL": f"https://github.com/godotengine/godot/releases/download/{args.godot_version}/Godot_v{args.godot_version}{godot_runtime}_linux_x86_64.zip",
                "GODOT": f"Godot_v{args.godot_version}{godot_runtime}_linux_x86_64/Godot_v{args.godot_version}{godot_runtime}_linux.x86_64",
                "GODOT_ZIP": f"Godot_v{args.godot_version}{godot_runtime}_linux_x86_64.zip",
            }
        else: 
            env = {
                "GODOT_VERSION": args.godot_version ,
                "GODOT_URL": f"https://github.com/godotengine/godot/releases/download/{args.godot_version}/Godot_v{args.godot_version}{godot_runtime}_linux.x86_64.zip",
